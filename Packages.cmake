...
macro(add_dependency)
    set(oneValueArgs NAME PACKAGE CMAKE_PKG REPO HASH URL)
	...
	if(DEPSADD_CMAKE_PKG)
		set(DEPS_${DEPSADD_PACKAGE}_PACKAGE_NAME ${DEPSADD_CMAKE_PKG})
	endif()
endmacro()

macro(use_dependency DEP_NAME)
    if(NOT DEPS_${DEP_NAME}_USED)
    	set(CMAKE_PACKAGE_NAME ${DEP_NAME})
		set(DEPS_${DEP_NAME}_USED)
		if(EXISTS "${VCPKG_INSTALLED_DIR}")
			message(STATUS "Looking for ${DEP_NAME}")
			if(DEPS_${DEP_NAME}_PACKAGE_NAME)
				set(CMAKE_PACKAGE_NAME ${DEPS_${DEP_NAME}_PACKAGE_NAME})
			endif()
			find_package(${CMAKE_PACKAGE_NAME} CONFIG QUIET)
		endif()
		if(NOT (EXISTS "${VCPKG_INSTALLED_DIR}" AND ${CMAKE_PACKAGE_NAME}_FOUND))
